...
const GuestLayout = () => {
    ...
    return (
        <div className="d-flex flex-column min-vh-100">
            ...
            <footer className="bg-dark text-white pt-5 pb-3 mt-3">
                <Container>
                    <Row className="g-4">
                        ...
                        <ul className="list-unstyled text-white-50 small">
                            <li className="mb-2">
                                <Link to="/" className="text-decoration-none text-white-50 hover-text-success">Trang chủ</Link>
                            </li>
                            <li className="mb-2">
                                {/* Chú ý đường dẫn /#gioi-thieu */}
                                <Link to="/#gioi-thieu" className="text-decoration-none text-white-50 hover-text-success">Giới thiệu đề tài</Link>
                            </li>
                            <li className="mb-2">
                                {/* Chú ý đường dẫn /#huong-dan */}
                                <Link to="/#huong-dan" className="text-decoration-none text-white-50 hover-text-success">Hướng dẫn tra cứu</Link>
                            </li>
                            <li className="mb-2">
                                <Link to="/login" className="text-decoration-none text-white-50 hover-text-success">Dành cho Quản trị viên</Link>
                            </li>
                        </ul>
                    </Col>
                        ...
                        <Col md={4}>
                            ...
                            <ul className="list-unstyled text-white-50 small">
                                <li className="mb-2 d-flex align-items-start">
                                    <FaMapMarkerAlt className="me-2 mt-1 text-success flex-shrink-0" /> 
                                    <div className="flex-grow-1">
                                        <div className="text-nowrap">
                                            Trường Công Nghệ Thông Tin và Truyền Thông - Đại học Cần Thơ
                                        </div>
                                        <div className="text-nowrap">
                                            Khu 2, Đại học Cần Thơ, đường 3/2, Ninh Kiều, Cần Thơ
                                        </div>
                                    </div>
                                </li>
                                <li className="mb-2 d-flex align-items-center">
                                    <FaEnvelope className="me-2 text-success flex-shrink-0" /> 
                                    <span>contact@plantdb.com</span>
                                </li>
                                <li className="mb-2 d-flex align-items-center">
                                    <FaPhone className="me-2 text-success flex-shrink-0" /> 
                    ...
                    <div className="text-center text-white-50 small">
                        <p className="mb-0">&copy; {new Date().getFullYear()} Plant Phenotype Database System</p>
                    </div>
                </Container>
            </footer>
        </div>
