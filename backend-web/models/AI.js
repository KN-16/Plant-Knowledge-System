...
export const PlantImage= sequelize.define('PlantImage', {
    ...
    url: { type: DataTypes.STRING, allowNull: false }, // URL hình ảnh
    part_type: { type: DataTypes.ENUM(...RAW_ENUMS.PART_TYPE), allowNull: false }, // Phần của cây (lá, hoa, thân, toàn cây)
    is_standard: { type: DataTypes.BOOLEAN, defaultValue: false }, // Có phải hình ảnh tiêu chuẩn không de tim kiem hinh anh
